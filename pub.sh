...
git init
git add .
git commit -am "publish" https://github.com/maixiaojie/maixiaojie.github.io.git
git push --force --quiet https://github.com/maixiaojie/maixiaojie.github.io.git master:gh-pages
cd ../
# 清理资源
rm -rf ./publish
rm -rf ./static
